...
int runnerUcast_activate(Blog_t *blog_p, uint8_t *prependData_p, int prependSize);
int runnerUcast_deactivate(uint32_t tuple);
int runnerUcast_update(BlogUpdate_t update, uint32_t tuple, Blog_t *blog_p);
