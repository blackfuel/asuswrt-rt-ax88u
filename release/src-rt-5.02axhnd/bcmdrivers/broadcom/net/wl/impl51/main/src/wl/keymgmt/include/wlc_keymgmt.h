...
int wlc_keymgmt_nan_pkt_need_enc(wlc_keymgmt_t *km, struct scb *scb, void *pkt);
...
#define wlc_keymgmt_nan_pkt_need_enc(km, scb, pkt)	0
#endif /* WLWSEC */
void wlc_keymgmt_get_wsec_info(wlc_keymgmt_t *km, wlc_bsscfg_t *bsscfg,
	wlc_keymgmt_wsec_info_t * wsec_info);
#ifdef WLCFP
union d11txhdr;
extern void key_aes_tx_mpdu_fast(wlc_key_t *key, uint8 *body, union d11txhdr *txd);
#endif // endif
