...
enum {
	...
	KM_SERIAL_TLV_B4M4_ENAB		= 8,
	KM_SERIAL_TLV_BSS_WSEC		= 9,
...
#ifdef BCMULP
void km_bsscfg_ulp_init(keymgmt_t *km, const wlc_bsscfg_t *bsscfg, km_bsscfg_flags_t flags);
#else
#define km_bsscfg_ulp_init(km, bsscfg, flags)
#endif /* BCMULP */
