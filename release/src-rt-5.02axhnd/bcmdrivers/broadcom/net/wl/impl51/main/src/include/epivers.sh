...
#
# $Id: epivers.sh 637158 2016-05-11 22:35:46Z $
...
if [ -f epivers.h ]; then
	...
	SVNURL='$HeadURL: http://bcawlan-svn.sj.broadcom.net/svn/bcawlan/proj/tags/KUDU/KUDU_REL_17_10_25_1503/src/include/epivers.sh $'
